...
NODE=https://github.com/kadena-io/chainweb-node/releases/download/1.4/chainweb.8.6.5.ubuntu-18.04.b7d7faa9.tar.gz
...
tar -xvf chainweb.8.6.5.ubuntu-18.04.b7d7faa9.tar.gz >> $LOG_FILE 2>&1
